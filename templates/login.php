...
<?php
	...
	if ($checked = valider("remember", "COOKIE")) $checked = "checked"; 
?>
<link rel="stylesheet" type="text/css" href="css/stylelogi.css">

<div class="formLogin">
<form action="controleur.php" method="GET">
	<h1 class="h3 mb-3 fw-normal">Connexion</h1>
	<div class="form-floating">
      <input type="mail" class="form-control" name="login" id="floatingInput login" placeholder="name@example.com" value="<?php echo $login;?>" />
...
<input class="w-45 btn btn-lg btn-secondary" type="submit" name="action" id="connexion" value="Connexion" />
</form>
</div>
